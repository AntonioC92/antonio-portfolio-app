...
- [x] **Shadow AI in marketing teams: the tools nobody approved** — `shadow-ai-marketing-tools` — Target: "shadow ai marketing tools" — Added 2026-09-19 (off-queue, trend-driven): unsanctioned AI tool use is running well ahead of any marketing-specific governance, GSC showed unanswered demand around "governed marketing workflows," and 80%+ of workers now use unapproved AI tools per 2026 industry research. Distinct from `ai-agent-governance-marketing-teams` (still open, covers autonomous agent permission scopes): this one covers employees pasting real customer and strategy data into consumer AI tools nobody vetted, and the cost/exposure that creates.

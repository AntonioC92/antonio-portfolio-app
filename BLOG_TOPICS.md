...
- [x] **Incrementality testing: a practical guide for small marketing teams** — `incrementality-testing-small-teams` — Target: "incrementality testing marketing" — Added 2026-09-21 (off-queue, trend-driven): Google cut its incrementality experiment minimum spend from $100k to $5k in late 2025 and Meta Conversion Lift remains free, which puts a practical geo holdout test within reach of a small team for the first time. Covers the geo holdout method, sample size and budget minimums, free/low-cost tools, and where it fits alongside attribution and mix modeling (both only mentioned incrementality in passing before this).

...
- [x] **What Google's new AI performance report in Search Console actually shows** — `search-console-ai-performance-report` — Target: "search console ai performance report" — Added 2026-09-25 (off-queue, trend-driven): Google's generative AI performance report rolled out globally in Search Console by August 31, 2026, giving site owners a first-party impressions count for AI Overviews and AI Mode for the first time, but with no clicks, no CTR, and no query data. Covers what the report shows, why it rolled out alongside the AI Max migration, and how to read the impressions number against Ahrefs' and Pew Research's click-decline data instead of over-reading it. The standard queue (marketing-data-source-of-truth, ai-time-savings-marketing-team, questions-before-hiring-fractional-cmo) remains covered by open unmerged branches.

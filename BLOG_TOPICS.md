...
- [x] **What agentic commerce protocols mean for your attribution setup** — `agentic-commerce-attribution-gap` — Target: "agentic commerce attribution" — Added 2026-09-22 (off-queue, trend-driven): ChatGPT retired Instant Checkout in March 2026 over tax and cart-integration problems, but the underlying protocol (ACP) and Google's Universal Commerce Protocol kept growing as backend product-feed infrastructure, creating a discovery-layer attribution gap even though checkout mostly still happens on the merchant's own site.
